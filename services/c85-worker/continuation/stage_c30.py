...
C30_STAGES = [
    ...
    Stage(name="fee_coverage", depends_on=(), run=run_fee_coverage, incremental=False,
    ...
    Stage(name="c30", depends_on=("fee_coverage", "fixed_floor", "external_direction"),
          run=run_c30, incremental=False,
          description="c30_c70_lab_manager_r2 selected shadow ledger"),
    Stage(name="phase3", depends_on=("c30",), run=run_phase3, incremental=False,
          description="c30_c70_lab_manager_r2_phase3 policy/fee/bootstrap tables"),
    Stage(name="c36_timing", depends_on=("phase3",), run=run_c36_timing, incremental=False,
