...
out = pathlib.Path('/dev-server/services/c85-worker/evaluation-fixtures/cache/c30root/c36f_repro_out'); out.mkdir(parents=True, exist_ok=True)
ref_dir = pathlib.Path('/dev-server/services/c85-worker/evaluation-fixtures/cache/upx/upstream/vault_work/legacy_c37/external_research/c36_fee_frontier_r3_output')
fr.OUT = out
fr.TIMING_OUT = pathlib.Path('/dev-server/services/c85-worker/evaluation-fixtures/cache/c30root/c36t_repro_out')  # connected upstream
fr.main()
total=0
