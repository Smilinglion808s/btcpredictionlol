...
BEGIN
  ...
  IF p_outbox IS NOT NULL AND p_outbox <> 'null'::jsonb THEN
    ...
    -- Backend expiry enforcement: if the transaction itself lands at or after
    -- the publication ceiling, the row is born EXPIRED and can never be
    -- dispatched late by a consumer or a crash-recovery sweep.
