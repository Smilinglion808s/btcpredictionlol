...
BEGIN
  ...
  IF NOT p_allow_backfill THEN
    ...
    -- official opportunity ledger. A live observation inserts its own context
    -- row, so an interval that was never imported into v11_context_rows would
    -- otherwise be invisible and permanently skipped.
    WITH owed AS (
