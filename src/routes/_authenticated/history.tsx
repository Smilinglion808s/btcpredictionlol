...
function enrich(p: PredRow): PredRow {
  ...
  const enriched: PredRow = {
    ...
    partial_completeness: (ai.partial_candle_module_context as Record<string, unknown> | undefined)?.completeness ?? "",
    partial_trust_tier: (ai.partial_candle_module_context as Record<string, unknown> | undefined)?.trust_tier ?? "",
    partial_direction: (ai.partial_candle_module_context as Record<string, unknown> | undefined)?.partial_direction ?? "",
    partial_close_position_pct: (ai.partial_candle_module_context as Record<string, unknown> | undefined)?.partial_close_position_pct ?? "",
    partial_range_vs_atr: (ai.partial_candle_module_context as Record<string, unknown> | undefined)?.partial_range_vs_atr ?? "",
    ...
    partial_vwap_event: (ai.partial_candle_module_context as Record<string, unknown> | undefined)?.partial_vwap_event ?? "",
    ...
    partial_feed_mismatch: (ai.partial_candle_module_context as Record<string, unknown> | undefined)?.feed_mismatch ?? "",
    partial_degraded_mode: (ai.partial_candle_module_context as Record<string, unknown> | undefined)?.degraded_mode ?? "",
