...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "BTC 15m Prediction Dashboard" },
      { name: "twitter:title", content: "BTC 15m Prediction Dashboard" },
      { property: "og:description", content: "Private dashboard for tracking BTC 15-minute candle predictions and win rate." },
      { name: "twitter:description", content: "Private dashboard for tracking BTC 15-minute candle predictions and win rate." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/2942f1e6-5c5c-4d1a-8a3c-a84fc96dd5de/id-preview-342abb9b--23a724c5-6c5b-4434-85e6-dc54b111c7e2.lovable.app-1782780136752.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/2942f1e6-5c5c-4d1a-8a3c-a84fc96dd5de/id-preview-342abb9b--23a724c5-6c5b-4434-85e6-dc54b111c7e2.lovable.app-1782780136752.png" },
