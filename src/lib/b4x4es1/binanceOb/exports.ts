...
export const FEATURE_EXPORT_COLUMNS = [
  ...
  "book_complete_10bps",
  "resync_generation",
  "resync_generation_min",
  "resync_generation_max",
  "resync_continuous",
  "feature_cutoff_ts",
  ...
  "final_bid_depth_btc_1bps",
  "final_ask_depth_btc_1bps",
  "final_total_depth_btc_1bps",
  "final_bid_depth_btc_2bps",
  "final_ask_depth_btc_2bps",
  "final_total_depth_btc_2bps",
  "final_bid_depth_btc_5bps",
  "final_ask_depth_btc_5bps",
  "final_total_depth_btc_5bps",
  "final_bid_depth_btc_10bps",
  "final_ask_depth_btc_10bps",
  "final_total_depth_btc_10bps",
  "final_bid_depth_usd_10bps",
  "final_ask_depth_usd_10bps",
