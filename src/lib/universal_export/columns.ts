...
export const LINEAGE_COLUMNS: ColumnDef[] = [
  ...
  { name: "a96_r3_counterfactual_result", category: "COUNTERFACTUAL", source: "a96_predictions.r3_counterfactual_result", description: "WIN / LOSS / PUSH / ABSTAIN for the r3 counterfactual against canonical OHLC." },
  { name: "a96_r3_counterfactual_result_score", category: "COUNTERFACTUAL", source: "a96_predictions.r3_counterfactual_result_score", description: "+1 / -1 / 0 score for the r3 counterfactual." },
